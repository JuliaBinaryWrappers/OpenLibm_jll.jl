# Autogenerated wrapper script for OpenLibm_jll for powerpc64le-linux-gnu
export libopenlibm
...
const libopenlibm_splitpath = ["lib", "libopenlibm.so"]
...
"""
function __init__()
    global artifact_dir = abspath(artifact"OpenLibm")
    ...
    global libopenlibm_handle = dlopen(libopenlibm_path)
